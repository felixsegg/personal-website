...
$pageTitle = t('contact', 'title', $lang, $translations);
$pageDescription = t('contact', 'description', $lang, $translations);
?>
<!DOCTYPE html>
...
<body>
    <div class="content">
        ...
        <p><?= nl2br(t('contact', 'content', $lang, $translations)) ?></p>
        <a href="mailto:felix@seggebaeing.de">felix(at)seggebaeing.de</a>
